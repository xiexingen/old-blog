...
在如下目录中新建一个文件 输入配置   
    ...
    ```  
    ![](~@post-img/dotnetcore/core/01/0803.png)
然后重启nginx ==》sudo nginx -s reload  
9. 查看成果  
在浏览器中输入192.168.2.105  如图
![](im~@post-img/dotnetcore/coreages/01/0901.png)
