<template>
  <v-footer dark
            height="auto"
            class="footer blog-footer darken-1 mt-3 primary">
    <v-card flat
            tile
            color="primary"
            class="primary--text text--lighten-4 text-xs-center py-3 card card--flat card--tile primary">
      <v-card-text v-html="$tt('license')"
                   class="pb-0 card__text"></v-card-text>
      <v-card-text class="pt-0 mt-1 card__text">
